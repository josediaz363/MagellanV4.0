...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function calculateDashboardProgress() {
        try {
            ...
            // try to calculate from budgeted hours and earned hours as a fallback
            console.log("Quantity columns not found or invalid, trying to calculate from budgeted hours and earned hours");
