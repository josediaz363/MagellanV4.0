 ...
 * 
 * This version maintains the working dashboard implementation and adds
 * support for the Project Overview page.
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log("Page detection:", { isDashboard, isProjectView });
    ...
    function calculateProjectProgress() {
        ...
        for (const card of progressCards) {
            if (card.textContent.includes('Overall Progress')) {
                ...
                if (progressText && progressText[1]) {
                    const progressValue = parseInt(progressText[1]);
                    if (!isNaN(progressValue)) {
                        console.log(`Project progress from card: ${progressValue}%`);
        ...
        // Third, try to get progress from sub jobs table
        ...
        // Fourth, try to get progress from work items in the project
        // This is a fallback for projects that have work items directly
        const workItemRows = document.querySelectorAll('tbody tr');
        ...
        // Fifth, look for any element with progress percentage
